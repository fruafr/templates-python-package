...
Welcome to `qush` contributor's guide.
...
If you experience bugs or general issues with `qush`, please have a look
...
You can help improve `qush` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`qush` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `qush`'s files. While this mechanism can
...
```
conda create -n qush python=3 six virtualenv pytest pytest-cov
conda activate qush
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/qush.git
   cd qush
   ```
...
5. Install [pre-commit]:
   ...
   `qush` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/qush
[issue tracker]: https://github.com/<USERNAME>/qush/issues
